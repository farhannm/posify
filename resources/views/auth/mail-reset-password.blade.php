<x-base-layout title="New Password">
    <div class="hidden w-full place-items-center lg:grid">
        <div class="w-full max-w-lg p-6">
            <img class="w-full" x-show="!$store.global.isDarkModeEnabled"
                src="{{ asset('images/illustrations/forgotPassword.svg') }}" alt="New Password Illustration" />
            <img class="w-full" x-show="$store.global.isDarkModeEnabled"
                src="{{ asset('images/illustrations/forgotPassword-dark.svg') }}" alt="New Password Dark Mode Illustration" />
        </div>
    </div>
    ...
    <main class="flex w-full flex-col items-center bg-white dark:bg-navy-700 lg:max-w-md">
        <div class="flex w-full max-w-sm grow flex-col justify-center p-5">
            <div class="text-center">
                ...
                <div class="mt-4">
                    <h2 class="text-2xl font-semibold text-slate-600 dark:text-navy-100">Set New Password</h2>
            ...
            <form class="mt-8" action="{{ route('forgotPassword') }}" method="POST">
                @csrf
                <div class="mb-4">
                    <label for="password" class="block text-sm font-medium text-slate-700 dark:text-navy-200">
                        Password Baru
                    </label>
