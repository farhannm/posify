        ...
        <div
            ...
            <div class="col-span-12 lg:col-span-8">
                <div class="flex items-center justify-between space-x-2">
                    <h2 class="text-3xl font-medium tracking-wide text-slate-800 line-clamp-1 dark:text-navy-100">
                        Ini Dashboard Admin
                    </h2>
                    ...
                    <div class="mt-4 flex shrink-0 flex-col items-center sm:items-start">
                        ...
                        <button
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4.5 w-4.5 text-slate-400 dark:text-navy-300" fill="none" viewBox="0 0 24 24"
