<x-base-layout title="POS System" is-header-blur="true">
    ...
    <main class="flex pos-app w-full px-[var(--margin-x)] pb-6 transition-all duration-[.25s] mt-20">
        <div class="sidebar">
            <div class="flex h-full flex-col dark:bg-navy-750">
                <!-- Sidebar Panel Header -->
                <div class="flex h-18 w-full items-center justify-between pl-4 pr-1">
                    <a href="{{ route('cashierDashboardView') }}">
                        <div class="flex items-center">
                            <img class="h-auto w-4 mr-2" src="{{ asset('images/official_logo.png') }}" alt="logo" />
                        ...
                        <ul class="space-y-1.5 px-2 font-inter text-xs+ font-medium">
                            <li>
                                <a class="group flex space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                                    href="{{ route('cashierDashboardView') }}">
                                    <span class="text-slate-800 dark:text-navy-100">Dashboard</span>
                                </a>
                            </li>
                            <li>
                                <a class="group flex space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                                    href="{{ route('viewAwaitingOrders') }}">
                                    <span class="text-slate-800 dark:text-navy-100">Awaiting</span>
                                </a>
                            </li>
                            <li>
                                <a class="group flex space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                                    href="{{ route('viewProcessedOrders') }}">
                                    <span class="text-slate-800 dark:text-navy-100">In process</span>
                                </a>
                            </li>
                            <li>
                                <a class="group flex space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                                    href="{{ route('viewOrderHistory') }}">
